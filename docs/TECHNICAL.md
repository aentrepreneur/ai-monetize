...
> Nota 2026-09:
> Este documento tecnico fue escrito para el pipeline de contenido/media.
> Las letras A/B/C/D se han reutilizado con el tiempo. Ver definicion actual en `docs/MODES.md`.
> Para Websites PyMEs (Modo D actual) ver `docs/MODE_D_WEBSITES_PLAYBOOK.md` y `ai_monetize/websites/`.
...
MODE_LEVEL_ADJUSTMENT = {
    ...
    "B": -5,   # Legacy: "Character" era mas dificil
    "C": -5,   # Legacy: "Cine" era mas dificil
    "D": 15,   # Legacy: "Auto-Pilot" era mas permisivo
}
...
Mode:           Ver `docs/MODES.md` (mapeo actual + legacy)
