...
> Nota 2026-09:
> Esta guia es principalmente "legacy" para el pipeline de contenido/media (Modo A y templates).
> Los nombres legacy de modos (AI Character / Cine Fusion / Auto-Pilot) aparecen aqui por historia.
> La definicion actual de A/B/C/D esta en `docs/MODES.md`.
> Para Websites PyMEs (Modo D actual) usa: `docs/MODE_D_WEBSITES_PLAYBOOK.md`.
